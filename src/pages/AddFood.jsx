...
const AddFood = () => {
    ...
    return (
        ...
        < section className="bg-white mt-20 min-h-[calc(100vh-72px)]" >
            <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                    <img
                        alt=""
                        src="https://i.ibb.co/Hhz7Pks/addFood.jpg"
                ...
                >
                    <div className="max-w-xl lg:max-w-3xl">
                        ...
                        <form onSubmit={handleAddFood} action="#" className="mt-8 grid grid-cols-6 gap-6">
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                <button
                                    className="inline-block shrink-0 rounded-md border border-blue-600 bg-black px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 dark:hover:bg-blue-700 dark:hover:text-white"
                                >
                                    Add Food
                                </button>
