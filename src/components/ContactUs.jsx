            ...
            <div className="max-w-screen-lg mx-auto p-5">
                <div className="grid grid-cols-1 md:grid-cols-12 border">
                    <div className="bg-gray-900 md:col-span-4 p-10 text-white">
                        ...
                        Get in touch with us today to experience the best in online food ordering. With a diverse menu and impeccable service, we are here to make your dining experience memorable.
                        </p>
                        ...
                        <div className="flex items-center mt-5">
                            ...
                            <span className="text-sm">House #14, Street #12, Mirpur-10, Dhaka Bangladesh.</span>
                        </div>
                        <div className="flex items-center mt-5">
